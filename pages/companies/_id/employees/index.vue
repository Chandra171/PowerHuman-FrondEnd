<template>
    ...
    <div class="lg:pr-[70px] py-[50px] lg:ml-[320px] xl:ml-[365px] px-4 lg:pl-0">
        ...
        <section class="pt-[50px]">
            ...
            <!-- v-else for prevent undefinied reading property 'result' -->
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:gap-10 lg:gap-3">
                ...
                <div class="items-center card py-6 md:!py-10 md:!px-[38px] !gap-y-0" v-else v-for="employee in employees.data.result.data">
                    ...
                    <img :src="employee.photo" class="rounded-full" width="70" alt="">
                    ...
                    <a v-else
                    href="#verify" class="text-blue-700 mt-[30px] underline relative z-20">
                        Verify Now
                    </a>
                </div>
            </div>
...
export default {
  ...
  async fetch() {
    // this.employees = await this.$axios.get('employee?company_id=' + this.$route.params.id + '&limit=100')
